...
- Setting up isolated virtual lab environments using VirtualBox
- Understanding networking concepts: NAT vs NAT Network, DHCP, DNS, static IP configuration
- Working with Kali Linux as a penetration testing platform
- Snapshot management for safe experimentation and quick recovery
- Basic network diagnostics (`ifconfig`, `ping`, connectivity testing)
- [ add more as you go — e.g. Nmap scanning, Metasploit, Wireshark, etc. ]
